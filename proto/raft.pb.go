...
type LogEntry struct {
	...
	Command       string                 `protobuf:"bytes,3,opt,name=command,proto3" json:"command,omitempty"` // Command to be applied (e.g., "PUT|key|value" or "DELETE|key")
...
type InstallSnapshotRequest struct {
	...
	Data              []byte                 `protobuf:"bytes,5,opt,name=data,proto3" json:"data,omitempty"`                                                       // Raw bytes of the snapshot
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
const file_proto_raft_proto_rawDesc = "" +
	...
	"\x0fInstallSnapshot\x12\x1c.raft.InstallSnapshotRequest\x1a\x1d.raft.InstallSnapshotResponseB,Z*github.com/distributed-kv-store/proto/raftb\x06proto3"
